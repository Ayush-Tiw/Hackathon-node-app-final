...
const stripe = new Stripe(
  "sk_test_51LUTLESGF1FrCVyXfcqAb9tWYSEm6Sg40rEfNPA0eHhW2AHupepjRcoVSFsFEHsOSolnpsGcgC8mS8JoBl3qepJ700rRwHjugT"
);
...
app.get("/", function (request, response) {
  response.send({
    message: "this is welcome page ,This is CORS-enabled for all origins!",
  });
});
...
app.post("/foods", async function (request, response) {
  ...
  result
    ...
    : response.send({ message: "data not correctly uploaded" });
